...
<title>กำหนดให้รับเฉพาะตัวเลข</title>
...
$(document).ready(function() {
	...
	$("#errNum").hide();
		...
		if (!numericReg.test(inputNum)) {
			$("#errNum").html("กรุณาป้อนรหัสไปรษณีย์เป็นตัวเลขเท่านั้น!!!").show().fadeIn(2000);
			return false;
		}	
	});	
});	
...
รหัสไปรษณีย์ : <input type="text" name="txtZipcode" id="txtZipcode"><span id="errNum" class="error"></span><br>
